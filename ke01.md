...
# Modell für strukturierte Dokumente
...
- Es kann mehrere Exemplate von einem Dokument geben
...
- Bei HTML z.B: die Tags bzw. dessen Inhalte (\<h1\>).

# Zeichencodierungen
## Was gibt eine Zeichencodierung an?
Der Inhalt ist ein Bestandteil des strukturierten Dokuments. Im wesentlichen Besteht eine Datei aus einer Folge von Texteinheiten (Zeichen) wie:
- Buchstaben
- Ziffern
- Interpunktionszeichen
- andere Zeichen

Diese müssen in Bits und Bytes kodiert werden, die Zeichencodierung gibt dazu die *Vorschrift* an!

## Was sind die Bestandteile des Codierungsmodells?
